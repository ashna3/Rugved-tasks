...
def generate_launch_description():
    ...
    map_path = '/home/ash/vedh_ros/src/astar_planner/maps/my_map.yaml'  # or wherever your YAML file is

    
    # Nav2 parameters file
    nav2_params_path = '/home/ash/vedh_ros/nav2_params.yaml'
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable='rviz2',
            name='rviz2',
            #arguments=['-d', '/absolute/path/to/your/astar_config.rviz'],
            output='screen',
